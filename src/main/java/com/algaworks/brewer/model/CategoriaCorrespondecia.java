...
@Entity
@Table(name="categoria_correspodencia")
public class CategoriaCorrespondecia implements Serializable {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		CategoriaCorrespondecia other = (CategoriaCorrespondecia) obj;
		if (codigo == null) {
