...
Brewer.UploadFoto = (function() {
	...
	function UploadFoto() {
		...
		this.apagaFotos = $('.js-remove-foto');
	}
	...
	function onUploadCompleto(resposta) {
		...
		$('.js-remove-foto').on('click', onRemoverFoto.bind(this, resposta));
	}
	
	function onRemoverFoto(resposta) {
		...
		$.ajax({
			...
			url: '/brewer/'+ resposta.tenantId +'/fotos/' + resposta.nome,
			method: 'DELETE'
