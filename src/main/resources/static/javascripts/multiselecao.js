...
Brewer.MultiSelecao = (function() {
	...
	function onSelecaoClicado() {
		...
		var selecaoChecboxchecados = this.selecaoCheckbox.filter(':checked');
		this.selecaoTodosCheckbox.prop('checked', selecaoChecboxchecados.length >= this.selecaoCheckbox.length);
		statusBotaoAcao.call(this, selecaoChecboxchecados.length);
